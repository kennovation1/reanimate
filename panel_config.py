...
'''
actionMap = {
        'S1': {'action': 'momentaryLamp', 'lampId': 'A2-AC'},
        'S2': {'action': 'momentaryLamp', 'lampId': 'A1-AC'},
        'S3': {'action': 'momentaryLamp', 'lampId': 'DS1-Negative'},
        'A1': {'action': 'momentaryLamp', 'lampId': 'A1-AC'},
        'A2': {'action': 'momentaryLamp', 'lampId': 'A2-AC'},
        'A3': {'action': 'momentaryLamp', 'lampId': 'A3-AC'},
        'A4': {'action': 'momentaryLamp', 'lampId': 'A4-AC'},
        'A5': {'action': 'momentaryLamp', 'lampId': 'A5-AB'},
        'A6': {'action': 'momentaryLamp', 'lampId': 'A6-AB'},
        'A7': {'action': 'momentaryLamp', 'lampId': 'A7-AB'},
        'A8': {'action': 'momentaryLamp', 'lampId': 'A8-AB'},
        'A9': {'action': 'momentaryLamp', 'lampId': 'A9-AB'},
        'A22': {'action': 'momentaryLamp', 'lampId': 'A22-AB'},
